...
namespace RESERVATION.Controllers
{
    public class CourseController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("courceId,courceName,limitMinNum,price,alertMessage")] T_COURSE t_COURSE)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("courceId,courceName,limitMinNum,price,alertMessage")] T_COURSE t_COURSE)
        {
